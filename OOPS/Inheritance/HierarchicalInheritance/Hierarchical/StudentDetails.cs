...
namespace HierarchicalInheritance
{
    ...
    public class StudentDetails:PersonalDetails
    {
        ...
        public StudentDetails(string studentID,string aID,string name,string fatherName,Gender gender,DateTime dob,Department department,Year year):base(aID,name,fatherName,gender,dob)
        {
            StudentID=studentID;
            Department=department;
            Year=year;
